...
<head>
    ...
    <title>D'realProject | Post</title>
</head>
...
<body>
    ...
    <div class="container main bg-white  p-4 mt-5">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <?php endforeach ?>
            <div class="change  mb-3   me-auto">
                <label for="formFile" class="form-label">Upload Photo</label>
                <input class="form-control" required name="Photo" type="file" id="Photo">
            </div>
            <div class="mb-3">
                <label for="caption" class="form-label">Caption</label>
                <textarea class="form-control" id="Caption" name="Caption" rows="3"></textarea>
            </div>
            <button type="submit" name="submit" id="submit" class="btn btn-primary">Let's Post</button>
        </form>
    </div>
