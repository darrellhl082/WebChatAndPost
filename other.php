...
<body>
    ...
    <div class="list-group chatList mobile">
        ...
        <a href="accountView.php?id=<?php echo $identify["username"]; ?>"
            ...
            <div class="avatarField">
                <img src="img/avatar/<?php echo $identify["avatarUser"] ?>" class="avatar rounded-circle img-thumbnail"
                    alt="">
