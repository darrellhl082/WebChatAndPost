...
$user = query("SELECT * FROM users WHERE username = '$id' ");
...
<head>
    ...
    * {
    ...
    <title>TwitGram | <?php echo $user[0]["username"]?></title>
</head>
...
<body>
    ...
    <div class="content">
        <div class="bg"></div>
        <div class="jumbotron w-50 ms-auto me-auto mt-2 pt-5 mb-5 bg-white text-center">
            <a href="#" class="text-decoration-none ">
                <?php foreach ($user as $identify) :?>

                <img src="img/avatar/<?php echo $identify["avatarUser"]; ?>"
                    class="img-thumbnail w-25 mb-2 rounded-circle" alt=" <?php echo $identify["username"]; ?>">
                <p class="fs-2" text-decoration-none"> <?php echo $identify["username"]; ?></p>
                <?php endforeach ?>
            </a>
            <a href="chat.php?id=<?php echo $user[0]["username"]?>"
                class="mb-3 desk chatBtn btn btn-primary w-md-5 ">Send
                Message</a>
            <a href="chatMob.php?id=<?php echo $user[0]["username"]?>"
                class="mb-3 mob chatBtn btn btn-primary w-md-5 ">Send
                Message</a>
    ...
    <script>
    let id = <?php echo $idCheck?>;
    let idCheck = <?php echo $user[0]["IDUser"]?>;
